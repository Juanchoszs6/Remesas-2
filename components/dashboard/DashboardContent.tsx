...
import type { DocumentType, TimeRange } from '../analytics/AnalyticsChart';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <FileUpload onFilesUploaded={(files) => {
                toast.success(`Se subieron ${files.length} archivos correctamente`);
              }} />
            </CardContent>
          </Card>
        </div>
