...
import type { DocumentType, ProcessedData } from '@/components/analytics/AnalyticsChart';
...
export default function AnalyticsPage() {
  ...
  const handleFilesUploaded = useCallback(async (files: Array<{ type: DocumentType; file: File }>) => {
    try {
      ...
      // Switch to dashboard tab after processing
              ...
              <CardContent>
                <div className="space-y-4">
                  {Object.entries({
                    ...
                    // Only show progress for non-zero counts or if it's the current upload
